function [nlogL] = likelihoodFitPros(sigma_m,sigma_s,expData,t,distTestEndpts,lookUpTab,maxDistAll,sigMmax,distFromTarget,endPtsFB,target1,reaches,indicated)
...
if nargin > 11
    ...
    % log likelihood of sigma_m given indicated point:
    LLigivene = log2disotnormal(indicated,target1,sigma_m);
